...
const [filters, setFilters] = useAgentsFilters();
  ...
  return (
    <div className="flex-1 pb-4 px-4 md:px-8 flex flex-col gap-y-4">
     ...
     {   data.items.length === 0 && 
     <EmptyState title="Create your first agent" description="Create an agent to join your meeting. Each agent will follow your instructions and interact with participants during the call" />}
    </div>
  );
};
